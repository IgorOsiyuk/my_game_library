...
`),(({theme})=>theme.colors.white),(({theme,$isError})=>$isError?theme.colors.red:theme.colors.white),(({theme})=>theme.radius.rounded_xsmall),SvgImage.Z),HiddenCheckbox=styled_components_browser_esm.ZP.input(t2||(t2=_`
  position: absolute;
  opacity: 0;
  cursor: pointer;
  height: 0;
...
`),CheckboxIcon,SvgImage.Z),Label=(0,styled_components_browser_esm.ZP)(Text.Z)(t3||(t3=_`
  cursor: pointer;
  user-select: none;
`)),Error=styled_components_browser_esm.ZP.div(t5||(t5=_`
  ${0}
...
//# sourceMappingURL=components-atomic-Checkbox-Checkbox-stories.75a8731c.iframe.bundle.js.map