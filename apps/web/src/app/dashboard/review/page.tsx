          ...
          <div className="px-4 py-8">
            ...
            <div className="mt-8">
              <div className="grid grid-cols-8 gap-4">
                <div className="col-span-3 row-span-2 max-h-[500px] overflow-hidden flex justify-center self-center">
                  <Image
                    style={{
                      height: "100%",
                    }}
                ...
                <div className="col-span-3">
                  <div className="flex flex-col gap-4">
                    ...
                    <div>
                      <RadioGroup
                        size="sm"
                        label={<p className="text-sm">Статус прохождения</p>}
                    ...
                    <div>
                      <p>Ваша оценка:</p>
                      <div className="mt-1 flex flex-row-reverse justify-end items-center">
                        <input
              ...
              <div className="mt-4">
                <div>
                  <Textarea
                    minRows={10}
                    label="Комментарий "
                    placeholder="Краткая или неочень заметка об игре"
                  />
                </div>
              </div>
            </div>
