...
export class UserUserTokensToken1728120740959 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user_tokens" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" character varying NOT NULL, "isVerified" boolean NOT NULL DEFAULT false, CONSTRAINT "UQ_92ce9a299624e4c4ffd99b645b6" UNIQUE ("userId"), CONSTRAINT "PK_63764db9d9aaa4af33e07b2f4bf" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "token" ADD CONSTRAINT "FK_39ed5cc73d8cc72e62eeda77c12" FOREIGN KEY ("userTokenId") REFERENCES "user_tokens"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
